    ...
    return (
            ...
            <Flex  w={"full"} h={85} p={3} bgGradient={`linear(to-tr, pink.900 , black , black)`}  justify={'space-around'}
                ...
                <Flex w={"full"} direction={'row'} gap={2} justify={"space-between"} align={"center"}>
                    ...
                    <HStack flex={.3} >
                        {playBackStatus === 'idle' &&
                            <Skeleton rounded={'md'} boxSize={65} startColor='#212121' endColor='#424242'/>}
                        {playBackStatus === 'success' &&
                            <Image src={metaData?.metadata?.cover} alt='' boxSize={65} rounded={'md'}
                                   boxShadow={'2xl'}/>}
                        {playBackStatus === 'pending' &&
                            <Center w={"full"}><PropagateLoader color={'#41d636'} size={10}/></Center>}

                        <VStack spacing={0} align={"center"}>
                            {playBackStatus === 'idle' &&
                                <SkeletonText boxSize={120} height={4} noOfLines={2} spacing='1' startColor='#212121'
                                              endColor='#424242'/>}
                            {
                                playBackStatus === 'success' &&
                                <VStack align={"start"} spacing={0}>
                                    <Text overflow={"hidden"} whiteSpace={"nowrap"} textOverflow={"ellipsis"} w={95} fontSize={'sm'} fontWeight={'bold'}>{metaData?.metadata?.title}</Text>
                    ...
                    <HStack flex={2.2}>
                        <AudioPlayer
                            ...
                            customIcons={{
                                ...
                                loop: <Icon boxSize={6} bg={"whiteAlpha.300"} rounded={50} p={1} as={TbRepeat}/>,
                                loopOff: <Icon boxSize={6} bg={"whiteAlpha.300"} rounded={50} p={1} as={TbRepeatOff}/>,
                                ...
                                [
                                    ...
                                    <HStack spacing={2}>
                                        <Link href={metaData?.link} download>
                                            <Icon boxSize={6} bg={"whiteAlpha.300"} color={"whiteAlpha.600"} rounded={50} p={1}
                                                  as={RiDownload2Fill}/>
                                        </Link>
                                        <Icon boxSize={6} bg={"whiteAlpha.300"} color={"whiteAlpha.600"} rounded={50} p={1}
                                              as={RiHeart3Line}/>
